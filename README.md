...
- **WebKit / Safari:** my report https://bugs.webkit.org/show_bug.cgi?id=319998 (resolved as a duplicate of https://bugs.webkit.org/show_bug.cgi?id=316870, where the fix landed)
